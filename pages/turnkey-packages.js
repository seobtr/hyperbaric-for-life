  ...
  return (
    <>
      <div className="turnkey-packages-container">
        <Head>
          <title>
            Turnkey-Packages - Hyperbaric Manufacture - Waddell, AZ 85355 |
            Hyperbaric For Life
          </title>
          <meta
            property="og:title"
            content="Turnkey-Packages - Hyperbaric Manufacture - Waddell, AZ 85355 | Hyperbaric For Life"
          />
        </Head>
        ...
        <div className="turnkey-packages-hero">
          <div className="turnkey-packages-hero1">
            ...
            <div className="turnkey-packages-container03">
              <img
                alt="image"
                src="/playground_assets/hyperbaric%20hero%20image-600w.png"
        ...
        <div className="turnkey-packages-features">
          ...
          <span className="turnkey-packages-text07">
            Our largest and most versatile chamber. Physicians and practicioners
            can treat patients up to 3.0 ATA (29 psi) operating pressure. This
            chamber boasts a considerable 42&quot; diametric interior, yet is
            designed to fit in most offices and clinics. With mirrored controls
            inside and out the Fortius420® offers remarkably safe functionality
            at a wide range of protocols. Additionally, this chamber can deliver
            100% oxygen at up to 3.0 ATA through a hood assembly system to
            remain cost effective for physicians while being safe for patients.
            The chamber can be shipped and installed in less than 10 business
            days. This ground-breaking design and medical grade technology
            ensures durability and functionality that will last for years.
          </span>
          <div className="turnkey-packages-container04">
            <div className="turnkey-packages-container05">
              ...
              <div className="turnkey-packages-container07">
                <img
                  alt="image"
                  src="/playground_assets/hero%20image1-200h.png"
        ...
        <div className="turnkey-packages-features1">
          <div className="turnkey-packages-container08">
            <div className="turnkey-packages-container09">
              <h2 id="fortius420exp" className="turnkey-packages-heading2">
                <span className="turnkey-packages-text15">FORTIUS 420 EXP</span>
                <br></br>
              </h2>
              <h2 className="turnkey-packages-heading3">
                <span className="turnkey-packages-text17">(Split Chamber)</span>
                <br></br>
              </h2>
            </div>
          </div>
          <span className="turnkey-packages-text19">
            <span>
              The Fortius 420 -EXP is not just any hyperbaric chamber. This
              portable and two section design boasts a considerable 42″
              diametric interior. 62” in length when each 32 section is bolted
              together. The large interior diameter ensures that air can flow
              freely.
              <span
                dangerouslySetInnerHTML={{
                  __html: ' ',
          ...
          <div className="bannerQuote">
            <div className="turnkey-packages-container11">
              <blockquote className="turnkey-packages-text23">
                &quot;A Perfect Choice for for any Clinic or Office&quot;
              </blockquote>
            </div>
            <img
              alt="image"
                    ...
                    <div className="turnkey-packages-vertical-list">
                      <ul className="turnkey-packages-ul1 list">
                        <li className="list-item turnkey-packages-li03">
                          <span className="turnkey-packages-text24">
                      ...
                      <ul className="turnkey-packages-ul2 list">
                        <li className="list-item">
                          <span className="turnkey-packages-text25">
                            Boasts a considerable 42″ diametric interior and is
                            62” in length
                          </span>
                        </li>
                      </ul>
          ...
          <div className="features-container">
            <h2 className="turnkey-packages-text28">
              Benefits of the Fortius EXP
            </h2>
            <div className="turnkey-packages-container18">
              <img
                alt="image"
                src="/playground_assets/fortius%20420%20duplicate%20copy-1%20%5B1%5D-400w.png"
              ...
              <div className="turnkey-packages-feature-card1">
                ...
                <div className="turnkey-packages-container19">
                  <h3 className="turnkey-packages-text29">
                    <span>Fully Featured Portable Hard-Shell</span>
                    <br></br>
                  </h3>
                  <span className="turnkey-packages-text32">
                    <span>
              ...
              <div className="turnkey-packages-feature-card2">
                ...
                <div className="turnkey-packages-container20">
                  <h3 className="turnkey-packages-text35">
                    Split Chamber Design
                  </h3>
                  <span className="turnkey-packages-text36">
                    <span>
              ...
              <div className="turnkey-packages-feature-card3">
                ...
                <div className="turnkey-packages-container21">
                  <h3 className="turnkey-packages-text39">
                    Modular Hyperbaric: Expand your Fortius EXP
                  </h3>
                  <span className="turnkey-packages-text40">
          ...
          <div className="turnkey-packages-container22">
            <div className="turnkey-packages-container23">
              <div className="turnkey-packages-feature-card4">
                ...
                <h3 className="turnkey-packages-text41">Variable Pressure</h3>
                <span className="turnkey-packages-text42">Up to 3.0 ATA</span>
                <VerticalListSpec></VerticalListSpec>
                <span className="turnkey-packages-text43">
              ...
              <div className="turnkey-packages-feature-card5">
                ...
                <h3 className="turnkey-packages-text49">Controls</h3>
                <ul className="turnkey-packages-ul5 list">
                  <li className="turnkey-packages-li07 list-item">
                    <span className="turnkey-packages-text50">
                      Mirrored Interior/External Controls
                    </span>
                  </li>
                </ul>
                <div className="turnkey-packages-container24">
                  <h4 className="turnkey-packages-text51">External Controls</h4>
                  <span className="turnkey-packages-text52">For Operator</span>
                </div>
                <div className="turnkey-packages-container25">
                  <h4 className="turnkey-packages-text53">Internal Controls</h4>
                  <span className="turnkey-packages-text54">
                    User Self-Operation
                  </span>
                </div>
              ...
              <div className="turnkey-packages-feature-card6">
                ...
                <h3 className="turnkey-packages-text55">Weight</h3>
                <div className="turnkey-packages-container26">
                  <h4 className="turnkey-packages-text56">
                    Hard Shell Chamber:
                  </h4>
                  <span className="turnkey-packages-text57">
                    567 Kgs (1,250 Lbs)
                  </span>
                </div>
                <div className="turnkey-packages-container27">
                  <span className="turnkey-packages-text58">Compressor</span>
                  <span className="turnkey-packages-text59">
                    16.78 Kgs (37 Lbs)
                  </span>
                </div>
              </div>
              <div className="turnkey-packages-feature-card7">
                ...
                <h3 className="turnkey-packages-text60">Dimensions</h3>
                <div className="turnkey-packages-container28">
                  <div className="turnkey-packages-vertical-list-spec1">
                    <span className="turnkey-packages-text61">Length</span>
                    <div className="turnkey-packages-vertical-list2">
                      <ul className="turnkey-packages-ul6 list">
                        <li className="turnkey-packages-li08 list-item">
                          <span className="turnkey-packages-text62">
                ...
                <div className="turnkey-packages-container29">
                  <span className="turnkey-packages-text67">
                    Shell Diameter
                  </span>
                  <span className="turnkey-packages-text68">42 inch</span>
                </div>
                <div className="turnkey-packages-container30">
                  <span className="turnkey-packages-text69">Door Diameter</span>
                  <span className="turnkey-packages-text70">28 inch</span>
                </div>
              </div>
            </div>
          </div>
